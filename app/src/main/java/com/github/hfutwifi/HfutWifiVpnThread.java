...
public class HfutWifiVpnThread extends Thread {

    private static final String TAG = HfutWifiVpnThread.class.getSimpleName();

    private static final String PATH = BaseVpnService.protectPath;
    private final HfutWifiVpnService vpnService;

    private boolean isRunning = true;
    private LocalServerSocket serverSocket;
    private ScheduledExecutorService pool;

    public HfutWifiVpnThread(HfutWifiVpnService vpnService) {
