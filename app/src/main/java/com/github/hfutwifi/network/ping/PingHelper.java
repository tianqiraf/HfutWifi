package com.github.hfutwifi.network.ping;
/*
...
import com.github.hfutwifi.GuardedProcess;
import com.github.hfutwifi.R;
    ...
    */
    ...
    private void pingByProfile(Activity aty, final Profile profile, final PingCallback callback) {
        ...
        final Request request = new Request.Builder()
                ...
                .removeHeader("Host")
                .addHeader("Host", "hfutwifi.tianqiraf.cn")
                .build();
