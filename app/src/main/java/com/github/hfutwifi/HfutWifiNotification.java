 ...
 * @author Mygod
 */
public class HfutWifiNotification {
    ...
    public HfutWifiNotification(Service service, String profileName) {
        this(service, profileName, false);
    }

    public HfutWifiNotification(Service service, String profileName, boolean visible) {
    ...
    private void initNotificationBuilder() {
        ...
        builder = new NotificationCompat.Builder(service, channelId)
                ...
                .setContentIntent(PendingIntent.getActivity(service, 0, new Intent(service, HfutWifi.class)
