...
//import com.github.hfutwifi.job.AclSyncJob;
import com.github.hfutwifi.utils.Constants;
//import com.github.hfutwifi.utils.TcpFastOpen;
...
public class HfutWifiVpnService extends BaseVpnService {

    private static final String TAG = HfutWifiVpnService.class.getSimpleName();
    ...
    private HfutWifiVpnThread vpnThread;
    private HfutWifiNotification notification;
    ...
    public void startRunner(Profile profile) {
        ...
        if (VpnService.prepare(this) != null) {
            Intent i = new Intent(this, HfutWifiRunnerActivity.class);
    ...
    public void connect() throws NameNotResolvedException, KcpcliParseException {
        ...
        vpnThread = new HfutWifiVpnThread(this);
        vpnThread.start();
        ...
        */
        ...
        notification = new HfutWifiNotification(this, profile.name);
    }
