...
public class HfutWifiRunnerActivity extends Activity {
    private static final String TAG = HfutWifiRunnerActivity.class.getSimpleName();
    ...
    private void startBackgroundService() {
        if (app.isNatEnabled()) {
            ...
            Intent intent = VpnService.prepare(HfutWifiRunnerActivity.this);
            if (intent != null) {
