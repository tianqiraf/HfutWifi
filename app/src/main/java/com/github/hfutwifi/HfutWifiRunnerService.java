...
public class HfutWifiRunnerService extends ServiceBoundService {

    private static final String TAG = HfutWifiRunnerService.class.getSimpleName();
    ...
    protected void onServiceConnected() {
        if (bgService != null) {
            ...
            } else if (VpnService.prepare(HfutWifiRunnerService.this) == null) {
                startBackgroundService();
            } else {
